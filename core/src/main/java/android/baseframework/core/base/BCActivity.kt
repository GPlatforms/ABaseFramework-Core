...
open class BCActivity : RxAppCompatActivity(), ISupportActivity {
     ...
     * *****************************************************************
     */
    open fun initHeaderBar(titleId: Int, showBack: Boolean) {
    ...
    open fun initHeaderBar(title: String) {
        mHeaderBar = ViewLess.`$`(this, R.id.header)
    }
    ...
    open fun loadRootFragment(containerId: Int, toFragment: ISupportFragment, addToBackStack: Boolean, allowAnimation: Boolean) {
     ...
     */
    open fun setDefaultFragmentBackground(@DrawableRes backgroundRes: Int) {
